...
✅ Запрос на вывод принят
  Сумма: 25.00 CREDIT
  К получению: 24.875 USDC (комиссия 0.5%)
  Адрес: 0xD1c6...
  Статус: в обработке
...
5. **Комиссия 0.5%** — только на topup и withdraw. Переводы между агентами (pay) — бесплатно.
...
- Только сеть Base
- Комиссия: 0.5% на topup и withdraw, 0% на pay
